...
const int rs = 13, en = 11, d4 = 5, d5 = 4, d6 = 3, d7 = 2;//屏幕按helloworld接，只不过12-->13
...
byte rowPins[ROWS] = {12 ,10 ,9 ,8}; // connect rows from keypad to Arduino
byte colPins[COLS] = {7, 6, 1, 0}; // connect columns from keypad to Arduino
//键盘从左到右依次接
