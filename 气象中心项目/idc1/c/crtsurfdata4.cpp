 ...
 * 功能：本程序用于生成全国气象站点观测的分钟数据并生成.csv文件
  作者：topord
*/
...
int main(int argc, char *argv[])
{
  ...
  if(argc != 5){
    ...
    printf("Example:/project/idc2/bin/crtsurfdata4 /project/idc2/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata4.log json,csv,xml\n\n");
