...
void _help()
{
  ...
  printf("Using:/project/tools1/bin/ftpputfiles logfilename xmlbuffer\n\n");
   ...
   printf("Sample:/project/tools2/bin/procctl 30 /project/tools2/bin/ftpputfiles /log/idc/ftpputfiles_surfdata.log \"<host>172.20.119.29:21</host><mode>1</mode><username>root</username><password>#@!#!dqadsq!@#321</password><localpath>/idcdata/surfdata</localpath><remotepath>/tmp/ftpputtest</remotepath><matchname>SURF_ZH*.JSON</matchname><ptype>1</ptype><localpathbak>/tmp/idc/surfdatabak</localpathbak><okfilename>/idcdata/ftplist/ftpputfiles_surfdata.xml</okfilename><timeout>80</timeout><pname>ftpputfiles_surfdata</pname>\"\n\n\n");
