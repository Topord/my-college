/*
 *  程序名：migratetable.cpp，本程序是数据中心的公共功能模块，用于迁徙清理表中的数据。
 *  作者：topord。
*/
#include "_tools.h"
