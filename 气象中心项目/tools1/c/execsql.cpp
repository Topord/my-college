...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/project/tools2/bin/procctl 120 /project/tools2/bin/execsql /project/idc2/sql/cleardata.sql \"127.0.0.1,root,123456Aa.,mysql,3306\" utf8 /log/idc/execsql.log\n\n");
