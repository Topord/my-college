...
void _help(char *argv[])
{
  printf("Using:/project/tools2/bin/deletetable_oracle logfilename xmlbuffer\n\n");

  printf("Sample:/project/tools2/bin/procctl 3600 /project/tools2/bin/deletetable_oracle /log/idc/deletetable_oracle_ZHOBTMIND1.log \"<connstr>qxidc/qxidcpwd@snorcl11g_132</connstr><tname>T_ZHOBTMIND1</tname><keycol>keyid</keycol><where>where ddatetime<sysdate-0.03</where><starttime>01,02,03,04,05,13</starttime><timeout>120</timeout><pname>deletetable_oracle_ZHOBTMIND1</pname>\"\n\n");
