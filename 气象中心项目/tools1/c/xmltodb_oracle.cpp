...
void _help(char *argv[])
{
  printf("Using:/project/tools2/bin/xmltodb_oracle logfilename xmlbuffer\n\n");

  printf("Sample:/project/tools2/bin/procctl 10 /project/tools2/bin/xmltodb_oracle /log/idc/xmltodb_oracle_vip2.log \"<connstr>qxidc/qxidcpwd@snorcl11g_132</connstr><charset>Simplified Chinese_China.AL32UTF8</charset><inifilename>/project/tools2/ini/xmltodb.xml</inifilename><xmlpath>/idcdata/xmltodb/vip2</xmlpath><xmlpathbak>/idcdata/xmltodb/vip2bak</xmlpathbak><xmlpatherr>/idcdata/xmltodb/vip2err</xmlpatherr><timetvl>5</timetvl><timeout>50</timeout><pname>xmltodb_oracle_vip2</pname>\"\n\n");
