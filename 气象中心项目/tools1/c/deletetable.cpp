...
void _help()
{
  printf("Using:/project/tools2/bin/deletetable logfilename xmlbuffer\n\n");

  printf("Sample:/project/tools2/bin/procctl 3600 /project/tools2/bin/deletetable /log/idc/deletetable_ZHOBTMIND1.log \"<connstr>127.0.0.1,root,123456Aa.,mysql,3306</connstr><tname>T_ZHOBTMIND1</tname><keycol>keyid</keycol><where>where ddatetime<timestampadd(minute,-120,now())</where><starttime>01,02,03,04,05,13</starttime><timeout>120</timeout><pname>deletetable_ZHOBTMIND1</pname>\"\n\n");
